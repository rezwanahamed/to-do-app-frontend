  ...
  return (
    <>
      <>
        ...
        {isOpen && (
          <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black duration-300">
                ...
                <div className="flex flex-col-reverse md:flex-row">
                  <div className="flex flex-col justify-between md:w-80 md:border-r md:border-gray-200">
                    ...
                    <div className="flex items-center justify-between border-t border-gray-200 p-6">
                      ...
                      <button className="cursor-pointer rounded-md bg-blue-500 px-3 py-2 text-base text-sm font-medium whitespace-nowrap text-white hover:bg-blue-600">
                        Connect
                      </button>
                    </div>
                  </div>
